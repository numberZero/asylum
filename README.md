...
Southgate in 1994 for the Acorn Archimedes and is now public domain.  It has
been tested on Linux and Cygwin, but it should be possible to run it on other
...
';' and '.' to move and 'Enter' to fire, or remap the keys to something you
like better.
...
teleporter, stand in its centre and press "down" (that's '.' with the
